...
func test_current_stats_initialized():
	assert_not_null(stats_manager.current_stats, "current_stats should be initialized after _ready()")
	assert_true(stats_manager.current_stats is ShiftStats, "current_stats should be a ShiftStats instance")
