...
@export_range(0.0, 2.0) var base_glow_intensity: float = 0.8

## How much the glow intensity varies from the base (amplitude of the wave)
@export_range(0.0, 1.0) var pulse_amplitude: float = 0.3
...
@export_range(0.0, 0.5) var secondary_amplitude: float = 0.1
...
@export_range(0.0, 1.0) var glow_bloom: float = 0.25
...
func _setup_world_environment() -> void:
	...
	_environment.glow_hdr_scale = 2.5
