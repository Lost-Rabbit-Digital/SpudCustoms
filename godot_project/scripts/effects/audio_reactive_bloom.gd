...
@export_range(0.0, 2.0) var base_glow_intensity: float = 0.01

## Maximum additional glow intensity added by audio
@export_range(0.0, 3.0) var max_audio_glow: float = 0.025
...
@export_range(0.0, 1.0) var glow_bloom: float = 0.01
