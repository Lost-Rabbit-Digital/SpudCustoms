...
func spawn_potato():
	...
	var pos = Vector2(randf() * viewport_size.x, -50)  # Start above screen

	# Create random velocity
	var vel = Vector2(randf_range(-100, 100), randf_range(50, 150))  # Random horizontal velocity  # Random downward velocity
