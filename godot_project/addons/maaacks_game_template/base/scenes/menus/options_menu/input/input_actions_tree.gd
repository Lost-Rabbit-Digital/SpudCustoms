...
func _add_input_event_as_tree_item(
	action_name: String, input_event: InputEvent, parent_item: TreeItem
):
...
func _add_action_as_tree_item(
	readable_name: String, action_name: String, input_events: Array[InputEvent]
):
