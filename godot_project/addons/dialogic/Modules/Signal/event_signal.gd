...
func build_event_editor() -> void:
	...
	add_header_edit(
		"argument", ValueType.SINGLELINE_TEXT, {}, "argument_type == ArgumentTypes.STRING"
	)
	add_body_edit(
		"argument_type",
		ValueType.FIXED_OPTIONS,
		{
			"left_text": "Argument Type:",
			"options":
			[
				{
					"label": "String",
	...
	add_body_edit(
		...
		{"left_text": "Dictionary"},
		"argument_type == ArgumentTypes.DICTIONARY"
	)
