...
func _get_subsystems() -> Array:
	return [
		{"name": "Portraits", "script": this_folder.path_join("subsystem_portraits.gd")},
		{"name": "PortraitContainers", "script": this_folder.path_join("subsystem_containers.gd")}
	]
	...
	return [
		{
			"command": "portrait",
			"subsystem": "Portraits",
			"method": "text_effect_portrait",
			"arg": true
		},
		{
			"command": "extra_data",
			"subsystem": "Portraits",
			"method": "text_effect_extradata",
			"arg": true
		},
	]
