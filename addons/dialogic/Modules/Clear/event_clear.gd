...
func _execute() -> void:
	...
	if (
		clear_portraits
		and dialogic.has_subsystem("Portraits")
		and len(dialogic.Portraits.get_joined_characters()) != 0
	):
		if final_time == 0:
	...
	if (
		clear_background
		and dialogic.has_subsystem("Backgrounds")
		and dialogic.Backgrounds.has_background()
	):
...
func build_event_editor() -> void:
	...
	add_body_edit(
		...
		{
			"left_text": "Clear:",
			"icon": load("res://addons/dialogic/Modules/Clear/clear_textbox.svg"),
			"tooltip": "Clear Textbox"
		}
	)
	add_body_edit(
		"clear_portraits",
		ValueType.BOOL_BUTTON,
		{
			"icon": load("res://addons/dialogic/Modules/Clear/clear_characters.svg"),
			"tooltip": "Clear Portraits"
		}
	)
	add_body_edit(
		"clear_background",
		ValueType.BOOL_BUTTON,
		{
			"icon": load("res://addons/dialogic/Modules/Clear/clear_background.svg"),
	...
	add_body_edit(
		...
		ValueType.BOOL_BUTTON,
		{
			"icon": load("res://addons/dialogic/Modules/Clear/clear_music.svg"),
			"tooltip": "Clear Audio"
		}
	)
	add_body_edit(
		...
		ValueType.BOOL_BUTTON,
		{
			"icon": load("res://addons/dialogic/Modules/Clear/clear_style.svg"),
			"tooltip": "Clear Style"
		}
	)
	add_body_edit(
		"clear_portrait_positions",
		ValueType.BOOL_BUTTON,
		{
			"icon": load("res://addons/dialogic/Modules/Clear/clear_positions.svg"),
			"tooltip": "Clear Portrait Positions"
		}
	)
