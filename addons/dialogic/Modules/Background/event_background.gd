...
func get_shortcode_parameters() -> Dictionary:
	return {
		...
		"transition":
		{"property": "transition", "default": "", "suggestions": get_transition_suggestions},
	}
...
func build_event_editor() -> void:
	...
	add_header_edit(
		...
		ValueType.FIXED_OPTIONS,
		{
			...
			"options":
			[
				{"label": "Image", "value": ArgumentTypes.IMAGE, "icon": ["Image", "EditorIcons"]},
				{
	...
	add_header_edit(
		...
		{
			"file_filter":
			"*.jpg, *.jpeg, *.png, *.webp, *.tga, *svg, *.bmp, *.dds, *.exr, *.hdr; Supported Image Files",
...
func get_transition_suggestions(_filter: String = "") -> Dictionary:
	...
	for i in transitions:
		suggestions[DialogicUtil.pretty_name(i)] = {
			"value": DialogicUtil.pretty_name(i), "editor_icon": ["PopupMenu", "EditorIcons"]
		}
	return suggestions
